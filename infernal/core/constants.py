...
MATCH_QUEUES = {
    '0':                        'Custom',
    '2':                        '(Deprecated) Summoner\'s Rift; 5v5 Blind Pick games',
    '4':                        '(Deprecated) Summoner\'s Rift; 5v5 Ranked Solo games',
    '6':                        '(Deprecated) Summoner\'s Rift; 5v5 Ranked Premade games',
    '7':                        '(Deprecated) Summoner\'s Rift; Co-op vs AI games',
    '8':                        '(Deprecated) Twisted Treeline; 3v3 Normal games',
    '9':                        '(Deprecated) Twisted Treeline; 3v3 Ranked Flex games',
    '14':                       '(Deprecated) Summoner\'s Rift; 5v5 Draft Pick games',
    '16':                       '(Deprecated) Crystal Scar; 5v5 Dominion Blind Pick games',
    '17':                       '(Deprecated) Crystal Scar; 5v5 Dominion Draft Pick games',
    '25':                       '(Deprecated) Crystal Scar; Dominion Co-op vs AI games',
    '31':                       '(Deprecated) Summoner\'s Rift; Co-op vs AI Intro Bot games',
    '32':                       '(Deprecated) Summoner\'s Rift; Co-op vs AI Beginner Bot games',
    '33':                       '(Deprecated) Summoner\'s Rift; Co-op vs AI Intermediate Bot games',
